...
public class SafeCrackInteraction extends Interaction{

    public SafeCrackInteraction(InteractionPi pi, String interactionName, String interactionSolution, int phase) {
